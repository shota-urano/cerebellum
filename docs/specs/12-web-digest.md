...
- 経路 `/digest`。導線は**タスク行（detailRef）のみ**（2026-07-28 の位置づけ。07-29 朝にドロワー項目化したが同日夕方に撤去して回帰——常設ナビはタスク起点の詳細ビューを持たない → [`16-web-navigation.md`](./16-web-navigation.md) §3）
